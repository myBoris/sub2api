...
func (_u *GroupUpdate) SetBalanceTier(v string) *GroupUpdate {
	_u.mutation.SetBalanceTier(v)
	return _u
}

// SetNillableBalanceTier sets the "balance_tier" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableBalanceTier(v *string) *GroupUpdate {
	if v != nil {
		_u.SetBalanceTier(*v)
	}
	return _u
...
func (_u *GroupUpdate) check() error {
	...
	if v, ok := _u.mutation.BalanceTier(); ok {
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.BalanceTier(); ok {
...
// SetBalanceTier sets the "balance_tier" field.
func (_u *GroupUpdateOne) SetBalanceTier(v string) *GroupUpdateOne {
	_u.mutation.SetBalanceTier(v)
	return _u
}

// SetNillableBalanceTier sets the "balance_tier" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableBalanceTier(v *string) *GroupUpdateOne {
	if v != nil {
		_u.SetBalanceTier(*v)
	}
	return _u
